...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 4";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 259;
    global.mark_arr[0,1] = 280;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 306;
    global.mark_arr[1,1] = 295;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 233;
    global.mark_arr[2,1] = 198;
...
room_instance_add(argument0,192,208,ceil_2high_obj);
room_instance_add(argument0,192,176,ceil_2high_obj);
room_instance_add(argument0,224,176,ceil_2high_obj);
...
room_instance_add(argument0,320,160,wall_2high_hor_obj);
room_instance_add(argument0,288,160,wall_2high_hor_obj);
room_instance_add(argument0,256,160,wall_2high_hor_obj);
room_instance_add(argument0,224,160,wall_2high_hor_obj);
room_instance_add(argument0,256,352,wall_doorway_inv_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,176,208,wall_2high_vert_obj);
room_instance_add(argument0,176,176,wall_2high_vert_obj);
room_instance_add(argument0,336,176,wall_2high_vert_obj);
room_instance_add(argument0,336,208,wall_2high_vert_obj);
room_instance_add(argument0,336,240,wall_2high_vert_obj);
// Props
room_instance_add(argument0,192,208,bed_rand_obj);
room_instance_add(argument0,256,168,drawer_rand_south_obj);
room_instance_add(argument0,320,336,table_rand_obj);
room_instance_add(argument0,336,272,frame_vert_rand_obj);
