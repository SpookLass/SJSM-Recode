...
(
    argument0,"
    global.rm_name_var = 'Small Room 2'
    // Spawn
...
room_instance_add(argument0,256,240,rug_rand_obj);
room_instance_add(argument0,256,288,painting_hor_obj);
room_instance_add(argument0,256,192,painting_hor_obj);
// Not yet