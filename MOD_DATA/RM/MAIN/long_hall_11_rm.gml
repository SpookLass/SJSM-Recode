...
(
    argument0,"
    global.rm_name_var = 'Long Hall 11'
    // Spawn
...
// Paintings
// Not yet
/*room_instance_add(argument0,299,402,webs_obj);
room_instance_add(argument0,374,336,webs_obj);
room_instance_add(argument0,452,328,webs_obj);*/