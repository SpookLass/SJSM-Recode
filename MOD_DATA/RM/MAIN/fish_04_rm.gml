...
global.rm_name_var = ini_read_string('ROOM','fish','ROOM_fish')+' 4';
ini_close();
    ...
    global.mark_arr[0,1] = 269;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 339;
    global.mark_arr[1,1] = 225;
...
// Props
room_instance_add(argument0,256,224,tank_rand_obj);
