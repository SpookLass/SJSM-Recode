...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","fish","ROOM_fish")+" 5";
    ini_close();
...
// Props
room_instance_add(argument0,272,224,tank_rand_obj);
room_instance_add(argument0,272,288,tank_rand_obj);
room_instance_add(argument0,368,224,tank_rand_obj);
room_instance_add(argument0,368,288,tank_rand_obj);
room_instance_add(argument0,464,288,tank_rand_obj);
room_instance_add(argument0,464,224,tank_rand_obj);