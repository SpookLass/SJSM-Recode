...
(
	...
	global.rm_name_var = ini_read_string("ROOM","med_s","ROOM_med_s")+" 2";
	ini_close();
...
room_instance_add(argument0,400,272,wall_pit_hor_obj);
room_instance_add(argument0,400,240,wall_pit_hor_obj);
room_instance_add(argument0,368,240,wall_pit_hor_obj);
...
room_instance_add(argument0,400,272,wall_float_hor_obj);
room_instance_add(argument0,400,240,wall_float_hor_obj);
room_instance_add(argument0,368,240,wall_float_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,352,320,wall_pit_vert_obj);
room_instance_add(argument0,288,320,wall_pit_vert_obj);
room_instance_add(argument0,416,256,wall_pit_vert_obj);
...
room_instance_add(argument0,352,320,wall_float_vert_obj);
room_instance_add(argument0,288,320,wall_float_vert_obj);
room_instance_add(argument0,416,256,wall_float_vert_obj);
