...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","school_class","ROOM_school_class")+" 1"
    ini_close();
    // Spawns
    ...
    with spawn_arr[1,4] { rm_var = school_01_rm; rm_spawn_var = 1; }
...
room_instance_add(argument0,224,256,school_desk_obj);
room_instance_add(argument0,288,256,school_desk_obj);
room_instance_add(argument0,256,224,school_desk_obj);
...
room_instance_add(argument0,280,288,chair_east_obj);
room_instance_add(argument0,280,256,chair_east_obj);
room_instance_add(argument0,280,224,chair_east_obj);
room_instance_add(argument0,248,224,chair_east_obj);
room_instance_add(argument0,216,256,chair_east_obj);
room_instance_add(argument0,384,208,school_clock_obj);
room_instance_add(argument0,384,268,school_poster_04_obj);
room_instance_add(argument0,384,248,school_stickynote_obj);