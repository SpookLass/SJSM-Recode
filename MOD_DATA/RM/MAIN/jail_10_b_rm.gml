...
(
	...
	global.rm_name_var = ini_read_string('ROOM','jail','ROOM_jail')+' 10 B';
	ini_close();
    // Spawn
...
room_instance_add(argument0,448,304,door_east_obj);
room_instance_add(argument0,440,304,door_trig_obj);
