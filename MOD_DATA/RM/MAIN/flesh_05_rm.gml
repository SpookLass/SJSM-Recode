...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","flesh","ROOM_flesh")+" 5";
    ini_close();
    // Spawn
    ...
    global.spawn_arr[1,0] = 816;
    global.spawn_arr[1,1] = 352;
    global.spawn_arr[1,2] = 0;
    global.spawn_arr[1,3] = 180;
    // Mark
    global.mark_len_var = 3;
    global.mark_arr[0,0] = 589;
    global.mark_arr[0,1] = 420;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 672;
    global.mark_arr[1,1] = 322;
...
room_instance_add(argument0,544,416,wall_vert_obj);
...
room_instance_add(argument0,832,352,wall_vert_obj);
room_instance_add(argument0,640,288,wall_vert_obj);
...
room_instance_add(argument0,784,368,wall_mon_hor_obj);
room_instance_add(argument0,656,400,wall_mon_hor_obj);
room_instance_add(argument0,592,432,wall_mon_hor_obj);
room_instance_add(argument0,624,432,wall_mon_hor_obj);
...
room_instance_add(argument0,544,288,wall_mon_vert_obj);
// Props
room_instance_add(argument0,656,320,flesh_arrow_obj);