...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','hall','ROOM_hall')+' 32';
    ini_close();
    // Spawn
...
// Props
room_instance_add(argument0,181,468,web_rand_obj);
room_instance_add(argument0,208,459,web_rand_obj);
room_instance_add(argument0,131,454,web_rand_obj);
room_instance_add(argument0,229,470,web_rand_obj);
room_instance_add(argument0,326,458,web_rand_obj);
room_instance_add(argument0,426,460,web_rand_obj);
room_instance_add(argument0,393,429,web_rand_obj);
room_instance_add(argument0,403,375,web_rand_obj);
room_instance_add(argument0,393,286,web_rand_obj);
room_instance_add(argument0,484,462,web_rand_obj);
room_instance_add(argument0,411,472,web_rand_obj);
room_instance_add(argument0,385,456,web_rand_obj);
room_instance_add(argument0,298,475,web_rand_obj);
room_instance_add(argument0,529,460,web_rand_obj);
room_instance_add(argument0,522,472,web_rand_obj);
room_instance_add(argument0,597,467,web_rand_obj);
room_instance_add(argument0,678,471,web_rand_obj);
room_instance_add(argument0,665,457,web_rand_obj);
room_instance_add(argument0,541,471,web_rand_obj);
room_instance_add(argument0,353,456,web_rand_obj);
room_instance_add(argument0,343,469,web_rand_obj);
room_instance_add(argument0,307,460,web_rand_obj);
room_instance_add(argument0,286,473,web_rand_obj);
room_instance_add(argument0,235,452,web_rand_obj);
room_instance_add(argument0,251,465,web_rand_obj);
room_instance_add(argument0,389,472,web_rand_obj);
room_instance_add(argument0,466,458,web_rand_obj);
room_instance_add(argument0,452,472,web_rand_obj);
room_instance_add(argument0,467,472,web_rand_obj);
room_instance_add(argument0,190,449,web_rand_obj);
room_instance_add(argument0,153,464,web_rand_obj);
// Jumpscare
room_instance_add(argument0,640,480,js_obj);