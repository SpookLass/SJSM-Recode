...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 8";
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 362;
    global.mark_arr[0,1] = 243;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 411;
...
room_instance_add(argument0,272,400,wall_2high_vert_obj);
...
// Prop
room_instance_add(argument0,416,320,lab_window_hor_obj);