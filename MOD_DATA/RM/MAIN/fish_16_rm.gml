...
(
	...
	global.rm_name_var = ini_read_string('ROOM','fish','ROOM_fish')+' 16';
	ini_close();
...
room_instance_add(argument0,544,224,ceil_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,544,208,wall_hor_obj);
...
room_instance_add(argument0,400,128,wall_vert_obj);
...
room_instance_add(argument0,512,224,tank_rand_obj);
room_instance_add(argument0,544,224,tank_rand_obj);
room_instance_add(argument0,544,288,tank_rand_obj);
