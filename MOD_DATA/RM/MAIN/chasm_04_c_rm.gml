...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 4 C";
    ini_close();
    // Spawn
    global.spawn_len_var = 2;
    global.spawn_len_extra_var = 6;
    global.spawn_arr[0,0] = 368;
    ...
    global.mark_arr[0,0] = 368;
    global.mark_arr[0,1] = 267;
...
room_instance_add(argument0,368,192,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,224,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,256,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,288,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,320,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,352,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,384,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,368,416,floor_bridge_n56px_vert_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,352,192,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,224,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,256,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,288,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,320,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,352,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,384,rail_wood_n56px_vert_obj);
room_instance_add(argument0,352,416,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,192,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,224,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,256,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,288,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,320,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,352,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,384,rail_wood_n56px_vert_obj);
room_instance_add(argument0,384,416,rail_wood_n56px_vert_obj);
// Torches
