...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","amn_hall","ROOM_amn_hall")+" 2";
    ini_close();
    // Spawn
    ...
    global.mark_arr[2,0] = 390;
    global.mark_arr[2,1] = 418;
    global.mark_arr[2,2] = 0;
    global.mark_arr[3,0] = 416;
    global.mark_arr[3,1] = 363;
    global.mark_arr[3,2] = 0;
    global.mark_arr[4,0] = 440;
    global.mark_arr[4,1] = 420;
...
room_instance_add(argument0,528,416,wall_vert_obj);
// Siren
