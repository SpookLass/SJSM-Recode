...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 1";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,1] = 307;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 235;
    global.mark_arr[1,1] = 396;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 274;
    global.mark_arr[2,1] = 361;
...
room_instance_add(argument0,192,416,wall_2high_hor_obj);
room_instance_add(argument0,256,256,wall_doorway_inv_hor_obj);
// Walls (Vertical)
