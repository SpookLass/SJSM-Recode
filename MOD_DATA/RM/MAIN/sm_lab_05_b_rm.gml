...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 5 B";
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,2] = 32;
    global.mark_arr[1,0] = 101;
    global.mark_arr[1,1] = 244;
    global.mark_arr[1,2] = 32;
    global.mark_arr[2,0] = 303;
    global.mark_arr[2,1] = 241;
    global.mark_arr[2,2] = 32;
    mark_create_scr();
    // 3D Draw
    d3d_start();
...
room_instance_add(argument0,96,240,floor_high_obj);
room_instance_add(argument0,96,272,floor_high_obj);
room_instance_add(argument0,96,304,floor_high_obj);
room_instance_add(argument0,128,240,floor_high_obj);
room_instance_add(argument0,128,304,floor_high_obj);
...
room_instance_add(argument0,320,208,floor_high_obj);
room_instance_add(argument0,320,336,floor_high_obj);
room_instance_add(argument0,320,304,floor_high_obj);
room_instance_add(argument0,320,240,floor_high_obj);
...
// Ceilings
room_instance_add(argument0,96,240,ceil_2high_obj);
room_instance_add(argument0,96,272,ceil_2high_obj);
room_instance_add(argument0,96,304,ceil_2high_obj);
...
room_instance_add(argument0,96,224,wall_2high_hor_obj);
...
room_instance_add(argument0,96,320,wall_2high_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,80,304,wall_2high_vert_obj);
room_instance_add(argument0,80,272,wall_2high_vert_obj);
room_instance_add(argument0,80,240,wall_2high_vert_obj);
