...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","dun","ROOM_dun")+" 7";
    ini_close();
    // Spawn
    ...
    global.mark_arr[1,0] = 424;
    global.mark_arr[1,1] = 267;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 480;
    global.mark_arr[2,1] = 249;
...
room_instance_add(argument0,288,192,ceil_2high_obj);
...
room_instance_add(argument0,320,192,ceil_2high_obj);
...
room_instance_add(argument0,384,336,wall_2high_hor_obj);
room_instance_add(argument0,416,336,wall_2high_hor_obj);
...
room_instance_add(argument0,416,176,wall_2high_hor_obj);
room_instance_add(argument0,384,176,wall_2high_hor_obj);
room_instance_add(argument0,352,176,wall_2high_hor_obj);
room_instance_add(argument0,320,176,wall_2high_hor_obj);
room_instance_add(argument0,288,176,wall_2high_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,464,320,wall_2high_vert_obj);
room_instance_add(argument0,272,320,wall_2high_vert_obj);
room_instance_add(argument0,272,192,wall_2high_vert_obj);
room_instance_add(argument0,464,192,wall_2high_vert_obj);
// Torches
room_instance_add(argument0,320,176,torch_north_obj);
room_instance_add(argument0,416,176,torch_north_obj);
room_instance_add(argument0,320,336,torch_south_obj);
room_instance_add(argument0,416,336,torch_south_obj);
// Props
room_instance_add(argument0,368,176,chain_hor_rand_obj);
room_instance_add(argument0,368,336,chain_hor_rand_obj);