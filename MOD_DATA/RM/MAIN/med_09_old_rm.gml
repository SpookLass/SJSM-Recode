...
(
	...
	global.rm_name_var = ini_read_string("ROOM","med","ROOM_med")+" 9 "+ini_read_string("ROOM","old","ROOM_old");
	ini_close();
    // Spawn
...
room_instance_add(argument0,368,272,wall_vert_obj);
...
room_instance_add(argument0,344,240,wall_vert_obj);
room_instance_add(argument0,344,272,wall_vert_obj);
room_instance_add(argument0,344,304,wall_vert_obj);
room_instance_add(argument0,344,336,wall_vert_obj);
room_instance_add(argument0,344,368,wall_vert_obj);
room_instance_add(argument0,344,400,wall_vert_obj);
room_instance_add(argument0,344,432,wall_vert_obj);
