...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","engine","ROOM_engine")+" 9";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 232;
    global.mark_arr[0,1] = 228;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 350;
    global.mark_arr[1,1] = 260;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 297;
    global.mark_arr[2,1] = 220;
...
// Engineering
room_instance_add(argument0,208,192,engine_rand_obj);
room_instance_add(argument0,240,192,engine_rand_obj);
room_instance_add(argument0,272,192,engine_rand_obj);
room_instance_add(argument0,336,192,engine_rand_obj);
room_instance_add(argument0,368,192,engine_rand_obj);
room_instance_add(argument0,400,192,engine_rand_obj);
...
room_instance_add(argument0,208,192,pole_metal_obj);
room_instance_add(argument0,240,192,pole_metal_obj);
room_instance_add(argument0,272,192,pole_metal_obj);
