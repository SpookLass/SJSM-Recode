...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","dun","ROOM_dun")+" 1";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,1] = 232;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 362;
    global.mark_arr[1,1] = 238;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 453;
    global.mark_arr[2,1] = 270;
...
room_instance_add(argument0,416,208,torch_north_obj);
room_instance_add(argument0,480,208,torch_north_obj);
room_instance_add(argument0,256,304,torch_south_obj);
room_instance_add(argument0,320,304,torch_south_obj);
room_instance_add(argument0,416,304,torch_south_obj);
room_instance_add(argument0,480,304,torch_south_obj);
// Props
