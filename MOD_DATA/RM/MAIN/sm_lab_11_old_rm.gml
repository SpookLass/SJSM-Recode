...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 11 "+ini_read_string("ROOM","old","ROOM_old");
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 153;
    global.mark_arr[0,1] = 351;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 144;
    global.mark_arr[1,1] = 456;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 131;
    global.mark_arr[2,1] = 499;
