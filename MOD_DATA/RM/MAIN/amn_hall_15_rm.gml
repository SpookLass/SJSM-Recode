...
room_instance_add(argument0,288,288,floor_obj); // New
//Ceilings
...
room_instance_add(argument0,288,288,ceil_obj); // New
// Walls (Horizontal)
...
room_instance_add(argument0,288,272,wall_hor_obj); // New
// Walls (Vertical)
...
// Mermaid
room_instance_add(argument0,288,288,mur_spawn_obj);
// Grates
