...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 5 B";
    ini_close();
    // Spawn
...
room_instance_add(argument0,224,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,256,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,288,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,320,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,352,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,384,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,416,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,448,272,floor_bridge_3high_hor_obj);
...
room_instance_add(argument0,224,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,256,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,288,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,320,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,352,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,384,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,416,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,448,256,rail_wood_3high_hor_obj);
room_instance_add(argument0,224,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,256,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,288,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,320,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,352,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,384,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,416,288,rail_wood_3high_hor_obj);
room_instance_add(argument0,448,288,rail_wood_3high_hor_obj);
