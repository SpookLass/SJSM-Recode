...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","asy_cell","ROOM_asy_cell")+" 1"
    ini_close();
    // Spawns
    ...
    with spawn_arr[1,4] { rm_var = asy_02_rm; rm_spawn_var = 2; snd_len_var = 1; snd_arr[0] = door_m_02_snd; }
    with spawn_arr[1,5]
    {
...
// Props
room_instance_add(argument0,320,160,asy_bed_obj);
room_instance_add(argument0,248,196,asy_table_obj);
room_instance_add(argument0,248,196,asy_note_01_obj);