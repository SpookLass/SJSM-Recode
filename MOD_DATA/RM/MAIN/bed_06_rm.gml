...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 6";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,1] = 332;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 254;
    global.mark_arr[1,1] = 255;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 234;
    global.mark_arr[2,1] = 180;
...
// Props
room_instance_add(argument0,192,224,bed_rand_obj);