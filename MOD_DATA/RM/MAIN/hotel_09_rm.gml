...
(
	...
	global.rm_name_var = ini_read_string('ROOM','hotel','ROOM_hotel')+' 9';
	ini_close();
    // Spawn
    ...
    global.mark_arr[1,0] = 358;
    global.mark_arr[1,1] = 199;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 389;
...
// Torches
// Props
room_instance_add(argument0,384,240,doorframe_01_hor_obj);
room_instance_add(argument0,384,272,doorframe_01_hor_obj);
room_instance_add(argument0,384,240,doorframe_02_hor_obj);
room_instance_add(argument0,384,272,doorframe_02_hor_obj);