...
(
	...
	global.rm_name_var = ini_read_string("ROOM","med_s","ROOM_med_s")+" 5";
	ini_close();
    ...
    global.mark_arr[0,0] = 206;
    global.mark_arr[0,1] = 283;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 303;
    global.mark_arr[1,1] = 287;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 366;
    global.mark_arr[2,1] = 259;
...
room_instance_add(argument0,336,272,wall_pit_hor_obj);
room_instance_add(argument0,304,304,wall_pit_hor_obj);
room_instance_add(argument0,304,336,wall_pit_hor_obj);
room_instance_add(argument0,336,336,wall_pit_hor_obj);
room_instance_add(argument0,368,336,wall_pit_hor_obj);
room_instance_add(argument0,400,336,wall_pit_hor_obj);
room_instance_add(argument0,400,304,wall_pit_hor_obj);
...
room_instance_add(argument0,336,272,wall_float_hor_obj);
room_instance_add(argument0,304,304,wall_float_hor_obj);
room_instance_add(argument0,304,336,wall_float_hor_obj);
room_instance_add(argument0,336,336,wall_float_hor_obj);
room_instance_add(argument0,368,336,wall_float_hor_obj);
room_instance_add(argument0,400,336,wall_float_hor_obj);
room_instance_add(argument0,400,304,wall_float_hor_obj);
...
room_instance_add(argument0,416,320,wall_pit_vert_obj);
...
room_instance_add(argument0,416,320,wall_float_vert_obj);
