...
(
	...
	global.rm_name_var = ini_read_string('ROOM','tt','ROOM_tt')+' 4';
	ini_close();
    ...
    global.mark_arr[0,1] = 122;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 306;
    global.mark_arr[1,1] = 129;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 435;
    global.mark_arr[2,1] = 161;
...
room_instance_add(argument0,400,112,wall_hor_obj);
room_instance_add(argument0,432,112,wall_hor_obj);
...
// Walls (Vertical)
room_instance_add(argument0,416,160,wall_vert_obj);
room_instance_add(argument0,448,128,wall_vert_obj);
room_instance_add(argument0,448,160,wall_vert_obj);
room_instance_add(argument0,448,192,wall_vert_obj);
...
// Jumpscare
room_instance_add(argument0,384,144,js_obj);
