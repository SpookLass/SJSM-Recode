...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 7";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 247;
    global.mark_arr[0,1] = 305;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 301;
    global.mark_arr[1,1] = 273;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 205;
...
room_instance_add(argument0,224,352,wall_doorway_inv_hor_obj);
room_instance_add(argument0,288,352,wall_doorway_inv_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,288,232,drawer_rand_south_obj);
