...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 7";
	ini_close();
    // Spawn
...
room_instance_add(argument0,352,256,wall_2high_hor_obj);
room_instance_add(argument0,352,288,wall_2high_hor_obj);
