...
(
    ...
    "
    // Name
    global.rm_name_var = 'Thin Hall 1'
...
room_instance_add(argument0,240,152,ceil_obj);
room_instance_add(argument0,272,160,ceil_obj);
room_instance_add(argument0,304,152,ceil_obj);
room_instance_add(argument0,336,144,ceil_obj);
room_instance_add(argument0,368,136,ceil_obj);
room_instance_add(argument0,400,144,ceil_obj);
room_instance_add(argument0,432,152,ceil_obj);
room_instance_add(argument0,464,152,ceil_obj);
room_instance_add(argument0,496,152,ceil_obj);
room_instance_add(argument0,496,184,ceil_obj);
room_instance_add(argument0,496,216,ceil_obj);
room_instance_add(argument0,488,248,ceil_obj);
room_instance_add(argument0,496,280,ceil_obj);
room_instance_add(argument0,528,272,ceil_obj);
room_instance_add(argument0,560,280,ceil_obj);
// Torches
// Not yet