...
(
    argument0,"
    // Name
    global.rm_name_var = 'Hall 29 / Hall 2 B'
    // Spawn
...
room_instance_add(argument0,223,473,webs_obj);
room_instance_add(argument0,343,454,webs_obj);
room_instance_add(argument0,379,423,webs_obj);*/