...
(
	...
	global.rm_name_var = ini_read_string("ROOM","hotel","ROOM_hotel")+" 8";
	ini_close();
    // Spawn
    ...
    if local.gold
    {
        ...
        // Torch 1
        local.torch = instance_create(240,160,torch_gold_west_obj);
        local.torch.door_var = global.spawn_arr[1,4];
        // Torch 2
        local.torch = instance_create(240,224,torch_gold_west_obj);
...
// Flesh
room_instance_add(argument0,320,192,flesh_arrow_obj);