...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","school_class","ROOM_school_class")+" 4"
    ini_close();
    // Spawns
    ...
    with spawn_arr[1,4] { rm_var = school_01_rm; rm_spawn_var = 4; }
');
// Room settings
...
// Walls (Horizontal)
room_instance_add(argument0,208,176,spawn_wall_hor_obj);
room_instance_add(argument0,240,176,spawn_wall_hor_obj);
room_instance_add(argument0,272,176,spawn_wall_hor_obj);
room_instance_add(argument0,304,176,spawn_wall_hor_obj);
room_instance_add(argument0,368,176,spawn_wall_hor_obj);
...
room_instance_add(argument0,272,176,spawn_wall_hor_obj);
room_instance_add(argument0,304,176,spawn_wall_hor_obj);
room_instance_add(argument0,336,176,spawn_wall_hor_obj);
room_instance_add(argument0,368,176,spawn_wall_hor_obj);
...
// Props
room_instance_add(argument0,256,272,school_desk_obj);
room_instance_add(argument0,288,208,school_desk_obj);
room_instance_add(argument0,288,240,school_desk_obj);
room_instance_add(argument0,224,272,school_desk_obj);
room_instance_add(argument0,224,240,school_desk_obj);
room_instance_add(argument0,288,272,school_desk_obj);
room_instance_add(argument0,256,208,school_desk_obj);
room_instance_add(argument0,256,240,school_desk_obj);
...
room_instance_add(argument0,212,240,chair_east_obj);
room_instance_add(argument0,212,272,chair_east_obj);
room_instance_add(argument0,280,208,chair_east_obj);
room_instance_add(argument0,240,272,ghost_obj);
room_instance_add(argument0,240,208,ghost_obj);
room_instance_add(argument0,272,240,ghost_obj);
room_instance_add(argument0,208,288,ghost_obj);