...
(
	...
	global.rm_name_var = ini_read_string("ROOM","stor","ROOM_stor")+" 8";
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,1] = 233;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 388;
    global.mark_arr[1,1] = 275;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 435;
    global.mark_arr[2,1] = 273;
...
room_instance_add(argument0,336,304,crate_rand_obj);
room_instance_add(argument0,432,304,crate_rand_obj);
room_instance_add(argument0,464,304,crate_rand_obj);
room_instance_add(argument0,432,240,crate_rand_obj);