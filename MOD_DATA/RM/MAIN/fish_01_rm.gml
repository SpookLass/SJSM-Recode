...
global.rm_name_var = ini_read_string('ROOM','fish','ROOM_fish')+' 1';
ini_close();
    ...
    global.mark_arr[0,1] = 265;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 383;
    global.mark_arr[1,1] = 248;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 433;
...
room_instance_add(argument0,512,224,ceil_obj);
room_instance_add(argument0,480,224,ceil_obj);
...
room_instance_add(argument0,480,208,wall_hor_obj);
room_instance_add(argument0,512,208,wall_hor_obj);
...
room_instance_add(argument0,528,224,wall_vert_obj);
...
room_instance_add(argument0,480,224,tank_rand_obj);
...
room_instance_add(argument0,320,224,runner_obj);
room_instance_add(argument0,320,256,runner_obj);
room_instance_add(argument0,320,288,runner_obj);
room_instance_add(argument0,384,224,runner_obj);
room_instance_add(argument0,384,256,runner_obj);
room_instance_add(argument0,384,288,runner_obj);
room_instance_add(argument0,448,224,runner_obj);
room_instance_add(argument0,448,256,runner_obj);
room_instance_add(argument0,448,288,runner_obj);