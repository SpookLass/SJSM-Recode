...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","hall","ROOM_hall")+" 7 B";
    ini_close();
    // Spawn
...
room_instance_add(argument0,176,512,rail_metal_hor_obj);
room_instance_add(argument0,208,512,rail_metal_hor_obj);
room_instance_add(argument0,240,512,rail_metal_hor_obj);
room_instance_add(argument0,272,512,rail_metal_hor_obj);
room_instance_add(argument0,304,512,rail_metal_hor_obj);
room_instance_add(argument0,208,480,rail_metal_hor_obj);
room_instance_add(argument0,304,480,rail_metal_hor_obj);
room_instance_add(argument0,272,480,rail_metal_hor_obj);
room_instance_add(argument0,240,480,rail_metal_hor_obj);
room_instance_add(argument0,160,496,rail_metal_vert_obj);
room_instance_add(argument0,192,400,rail_metal_vert_obj);
room_instance_add(argument0,192,432,rail_metal_vert_obj);
room_instance_add(argument0,192,464,rail_metal_vert_obj);
room_instance_add(argument0,160,432,rail_metal_vert_obj);
room_instance_add(argument0,160,464,rail_metal_vert_obj);
room_instance_add(argument0,143,493,web_rand_obj);
room_instance_add(argument0,202,452,web_rand_obj);
room_instance_add(argument0,259,517,web_rand_obj);
room_instance_add(argument0,320,464,torch_east_obj);
room_instance_add(argument0,320,528,torch_east_obj);
// Jumpscare
room_instance_add(argument0,256,512,js_obj);