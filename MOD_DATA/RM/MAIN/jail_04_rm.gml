...
(
	...
	global.rm_name_var = ini_read_string('ROOM','jail','ROOM_jail')+' 4';
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 142;
    global.mark_arr[0,1] = 305;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 214;
    global.mark_arr[1,1] = 305;
...
room_instance_add(argument0,232,266,table_rand_obj);
room_instance_add(argument0,240,274,bone_rand_obj);
room_instance_add(argument0,176,299,web_rand_obj);
room_instance_add(argument0,324,296,web_rand_obj);
room_instance_add(argument0,249,342,web_rand_obj);
// Not yet
//room_instance_add(argument0,336,320,random_scare_mark1);