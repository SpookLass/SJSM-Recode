...
room_instance_add(argument0,247,452,webs_obj);
room_instance_add(argument0,310,504,webs_obj);
room_instance_add(argument0,253,569,webs_obj);
...
room_instance_add(argument0,208,384,rail_1_horr);
room_instance_add(argument0,240,384,rail_1_horr);
room_instance_add(argument0,272,384,rail_1_horr);
room_instance_add(argument0,240,416,rail_1_horr);
room_instance_add(argument0,208,416,rail_1_horr);
room_instance_add(argument0,176,416,rail_1_horr);
room_instance_add(argument0,144,416,rail_1_horr);
room_instance_add(argument0,288,400,rail_1_vert);
room_instance_add(argument0,288,432,rail_1_vert);
room_instance_add(argument0,256,432,rail_1_vert);
room_instance_add(argument0,256,592,rail_1_vert);
room_instance_add(argument0,288,592,rail_1_vert);
room_instance_add(argument0,288,560,rail_1_vert);
room_instance_add(argument0,256,560,rail_1_vert);
room_instance_add(argument0,256,528,rail_1_vert);
room_instance_add(argument0,288,528,rail_1_vert);
room_instance_add(argument0,288,496,rail_1_vert);
room_instance_add(argument0,256,496,rail_1_vert);
room_instance_add(argument0,256,464,rail_1_vert);
room_instance_add(argument0,288,464,rail_1_vert);*/