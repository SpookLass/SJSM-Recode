...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 9";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 419;
    global.mark_arr[0,1] = 304;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 557;
    global.mark_arr[1,1] = 304;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 742;
...
room_instance_add(argument0,816,368,wall_chasm_wide_hor_obj);
...
room_instance_add(argument0,624,368,wall_chasm_wide_hor_obj);
room_instance_add(argument0,688,368,wall_chasm_wide_hor_obj);
room_instance_add(argument0,752,368,wall_chasm_wide_hor_obj);
// Walls (Vertical)
