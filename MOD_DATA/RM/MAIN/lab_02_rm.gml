...
// Floors
room_instance_add(argument0,400,464,lab_floor_obj);
room_instance_add(argument0,432,464,lab_floor_obj);
room_instance_add(argument0,464,464,lab_floor_obj);
room_instance_add(argument0,496,464,lab_floor_obj);
room_instance_add(argument0,528,464,lab_floor_obj);
room_instance_add(argument0,560,464,lab_floor_obj);
room_instance_add(argument0,592,464,lab_floor_obj);
room_instance_add(argument0,624,496,lab_floor_obj);
room_instance_add(argument0,624,464,lab_floor_obj);
room_instance_add(argument0,624,432,lab_floor_obj);
room_instance_add(argument0,624,400,lab_floor_obj);
room_instance_add(argument0,656,400,lab_floor_obj);
room_instance_add(argument0,656,432,lab_floor_obj);
room_instance_add(argument0,656,464,lab_floor_obj);
room_instance_add(argument0,656,496,lab_floor_obj);
room_instance_add(argument0,656,528,lab_floor_obj);
room_instance_add(argument0,624,528,lab_floor_obj);
room_instance_add(argument0,688,528,lab_floor_obj);
room_instance_add(argument0,688,496,lab_floor_obj);
room_instance_add(argument0,688,464,lab_floor_obj);
room_instance_add(argument0,688,432,lab_floor_obj);
room_instance_add(argument0,688,400,lab_floor_obj);
// Ceilings
...
// Props
room_instance_add(argument0,432,464,lab_light_obj);
room_instance_add(argument0,496,464,lab_light_obj);
room_instance_add(argument0,560,464,lab_light_obj);
room_instance_add(argument0,656,400,lab_light_obj);
room_instance_add(argument0,656,464,lab_light_obj);
...
room_instance_add(argument0,690,468,lab_key_obj);
room_instance_add(argument0,688,464,lab_note_01_obj);