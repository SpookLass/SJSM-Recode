...
// Not yet
/*room_instance_add(argument0,324,496,random_scare_mark1);
room_instance_add(argument0,294,471,webs_obj);
room_instance_add(argument0,373,437,webs_obj);*/