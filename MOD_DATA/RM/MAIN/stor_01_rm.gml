...
(
	...
	global.rm_name_var = ini_read_string("ROOM","stor","ROOM_stor")+" 1";
	ini_close();
    // Spawn
...
room_instance_add(argument0,400,304,crate_rand_obj);