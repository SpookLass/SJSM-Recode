...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sc","ROOM_sc")+" 3";
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 355;
    global.mark_arr[0,1] = 282;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 440;
    global.mark_arr[1,1] = 302;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 585;
...
// Walls (Horizontal)
room_instance_add(argument0,112,304,wall_2high_hor_obj); // Lower
