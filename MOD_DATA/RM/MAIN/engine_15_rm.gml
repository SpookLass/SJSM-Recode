...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','engine','ROOM_engine')+' 15';
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 159;
    global.mark_arr[0,1] = 289;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 152;
    global.mark_arr[1,1] = 351;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 182;
    global.mark_arr[2,1] = 389;
...
room_instance_add(argument0,256,384,wall_vert_obj);
...
// Engineering
room_instance_add(argument0,224,288,bar_vert_obj);
room_instance_add(argument0,224,384,bar_vert_obj);
