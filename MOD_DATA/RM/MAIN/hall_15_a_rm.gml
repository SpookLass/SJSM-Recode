...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','hall','ROOM_hall')+' 15 A';
    ini_close();
    // Spawn
...
// Walls (Vertical)
room_instance_add(argument0,208,160,wall_vert_obj);
...
// Torches
room_instance_add(argument0,384,112,torch_north_obj);
room_instance_add(argument0,384,176,torch_north_obj);
room_instance_add(argument0,384,144,torch_south_obj);
room_instance_add(argument0,384,208,torch_south_obj);