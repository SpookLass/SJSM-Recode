...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 11 C";
    ini_close();
    // Spawn
    ...
    global.spawn_arr[4,0] = 352;
    global.spawn_arr[4,1] = 112;
    global.spawn_arr[4,2] = 0;
    global.spawn_arr[4,3] = 0;
    global.spawn_arr[5,0] = 704;
...
room_instance_add(argument0,352,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,384,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,416,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,448,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,480,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,512,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,544,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,576,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,608,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,640,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,672,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,704,112,floor_bridge_fake_hor_obj);
room_instance_add(argument0,304,256,floor_bridge_60px_vert_obj);
room_instance_add(argument0,304,288,floor_bridge_60px_vert_obj);
room_instance_add(argument0,304,320,floor_bridge_60px_vert_obj);
room_instance_add(argument0,304,352,floor_bridge_60px_vert_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,368,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,432,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,496,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,560,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,624,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,688,48,wall_chasm_wide_hor_obj);
room_instance_add(argument0,368,432,wall_chasm_wide_hor_obj);
room_instance_add(argument0,432,432,wall_chasm_wide_hor_obj);
room_instance_add(argument0,496,432,wall_chasm_wide_hor_obj);
room_instance_add(argument0,560,432,wall_chasm_wide_hor_obj);
room_instance_add(argument0,624,432,wall_chasm_wide_hor_obj);
...
room_instance_add(argument0,336,144,wall_chasm_wide_vert_obj);
room_instance_add(argument0,336,400,wall_chasm_wide_vert_obj);
room_instance_add(argument0,336,80,wall_chasm_wide_vert_obj);
room_instance_add(argument0,720,80,wall_chasm_wide_vert_obj);
room_instance_add(argument0,720,144,wall_chasm_wide_vert_obj);
...
room_instance_add(argument0,352,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,352,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,384,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,384,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,416,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,416,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,448,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,448,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,480,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,480,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,512,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,512,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,544,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,544,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,576,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,576,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,608,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,608,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,640,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,640,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,672,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,672,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,704,128,rail_wood_fake_hor_obj);
room_instance_add(argument0,704,96,rail_wood_fake_hor_obj);
room_instance_add(argument0,288,256,rail_wood_60px_vert_obj);
room_instance_add(argument0,288,288,rail_wood_60px_vert_obj);
room_instance_add(argument0,288,320,rail_wood_60px_vert_obj);
room_instance_add(argument0,288,352,rail_wood_60px_vert_obj);
room_instance_add(argument0,320,256,rail_wood_60px_vert_obj);
room_instance_add(argument0,320,288,rail_wood_60px_vert_obj);
room_instance_add(argument0,320,320,rail_wood_60px_vert_obj);
room_instance_add(argument0,320,352,rail_wood_60px_vert_obj);
// Torches
room_instance_add(argument0,432,48,torch_north_obj);
room_instance_add(argument0,624,48,torch_north_obj);
room_instance_add(argument0,528,48,torch_north_obj);