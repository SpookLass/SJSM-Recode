...
(
	...
	global.rm_name_var = ini_read_string('ROOM','hotel','ROOM_hotel')+' 14';
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 365;
    global.mark_arr[0,1] = 263;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 397;
    global.mark_arr[1,1] = 232;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 453;
    global.mark_arr[2,1] = 234;
...
room_instance_add(argument0,480,192,ceil_obj);
...
room_instance_add(argument0,480,176,wall_hor_obj);
...
room_instance_add(argument0,496,192,wall_vert_obj);
room_instance_add(argument0,496,224,wall_vert_obj);
room_instance_add(argument0,496,256,wall_vert_obj);
room_instance_add(argument0,464,288,wall_vert_obj);
// Torches
// Props
room_instance_add(argument0,352,192,doorframe_01_hor_obj);
room_instance_add(argument0,480,192,doorframe_01_hor_obj);
room_instance_add(argument0,352,192,doorframe_02_hor_obj);
room_instance_add(argument0,480,192,doorframe_02_hor_obj);