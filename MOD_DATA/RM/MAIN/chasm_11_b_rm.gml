...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 11 B";
    ini_close();
    // Spawn
    global.spawn_len_var = 2;
    global.spawn_len_extra_var = 6;
    global.spawn_arr[0,0] = 352;
    ...
    global.mark_arr[0,0] = 433;
    global.mark_arr[0,1] = 112;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 574;
    global.mark_arr[1,1] = 112;
...
room_instance_add(argument0,352,112,floor_bridge_hor_obj);
room_instance_add(argument0,384,112,floor_bridge_hor_obj);
room_instance_add(argument0,416,112,floor_bridge_hor_obj);
room_instance_add(argument0,448,112,floor_bridge_hor_obj);
room_instance_add(argument0,480,112,floor_bridge_hor_obj);
room_instance_add(argument0,512,112,floor_bridge_hor_obj);
room_instance_add(argument0,544,112,floor_bridge_hor_obj);
room_instance_add(argument0,576,112,floor_bridge_hor_obj);
room_instance_add(argument0,608,112,floor_bridge_hor_obj);
room_instance_add(argument0,640,112,floor_bridge_hor_obj);
room_instance_add(argument0,672,112,floor_bridge_hor_obj);
room_instance_add(argument0,704,112,floor_bridge_hor_obj);
...
room_instance_add(argument0,352,96,rail_wood_hor_obj);
room_instance_add(argument0,384,96,rail_wood_hor_obj);
room_instance_add(argument0,384,128,rail_wood_hor_obj);
room_instance_add(argument0,416,128,rail_wood_hor_obj);
room_instance_add(argument0,416,96,rail_wood_hor_obj);
room_instance_add(argument0,448,96,rail_wood_hor_obj);
room_instance_add(argument0,448,128,rail_wood_hor_obj);
room_instance_add(argument0,480,128,rail_wood_hor_obj);
room_instance_add(argument0,480,96,rail_wood_hor_obj);
room_instance_add(argument0,512,96,rail_wood_hor_obj);
room_instance_add(argument0,512,128,rail_wood_hor_obj);
room_instance_add(argument0,544,128,rail_wood_hor_obj);
room_instance_add(argument0,544,96,rail_wood_hor_obj);
room_instance_add(argument0,576,96,rail_wood_hor_obj);
room_instance_add(argument0,576,128,rail_wood_hor_obj);
room_instance_add(argument0,608,128,rail_wood_hor_obj);
room_instance_add(argument0,608,96,rail_wood_hor_obj);
room_instance_add(argument0,640,96,rail_wood_hor_obj);
room_instance_add(argument0,640,128,rail_wood_hor_obj);
room_instance_add(argument0,672,96,rail_wood_hor_obj);
room_instance_add(argument0,672,128,rail_wood_hor_obj);
room_instance_add(argument0,704,128,rail_wood_hor_obj);
room_instance_add(argument0,704,96,rail_wood_hor_obj);
