...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","school_class","ROOM_school_class")+" 3"
    ini_close();
    // Spawns
    ...
    with spawn_arr[1,4] { rm_var = school_01_rm; rm_spawn_var = 5; }
');
// Room settings
...
// Windows
room_instance_add(argument0,208,176,school_blind_hor_obj);
room_instance_add(argument0,240,176,school_blind_hor_obj);
room_instance_add(argument0,272,176,school_blind_hor_obj);
room_instance_add(argument0,304,176,school_blind_hor_obj);
room_instance_add(argument0,336,176,school_blind_hor_obj);
room_instance_add(argument0,368,176,school_blind_hor_obj);
...
room_instance_add(argument0,336,288,school_desk_obj);
room_instance_add(argument0,352,284,school_desk_obj);
room_instance_add(argument0,316,292,school_desk_obj);
room_instance_add(argument0,368,288,school_desk_obj);
room_instance_add(argument0,368,276,school_desk_obj);
room_instance_add(argument0,352,240,school_desk_teacher_obj);
room_instance_add(argument0,384,240,school_chalk_obj);
room_instance_add(argument0,384,260,school_clock_obj);
room_instance_add(argument0,248,208,chair_east_obj);
room_instance_add(argument0,256,208,school_note_02_obj);
