...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","dun","ROOM_dun")+" 4";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 318;
    global.mark_arr[0,1] = 281;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 427;
    global.mark_arr[1,1] = 251;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 565;
    global.mark_arr[2,1] = 262;
...
room_instance_add(argument0,464,288,wall_2high_vert_obj);
room_instance_add(argument0,464,224,wall_2high_vert_obj);
room_instance_add(argument0,624,224,wall_2high_vert_obj);
room_instance_add(argument0,624,256,wall_2high_vert_obj);
room_instance_add(argument0,624,288,wall_2high_vert_obj);
// Torches
room_instance_add(argument0,256,208,torch_north_obj);
room_instance_add(argument0,320,208,torch_north_obj);
room_instance_add(argument0,512,208,torch_north_obj);
room_instance_add(argument0,576,208,torch_north_obj);
room_instance_add(argument0,256,304,torch_south_obj);
room_instance_add(argument0,320,304,torch_south_obj);
room_instance_add(argument0,512,304,torch_south_obj);
room_instance_add(argument0,576,304,torch_south_obj);
// Props
