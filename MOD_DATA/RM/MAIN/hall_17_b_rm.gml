...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','hall','ROOM_hall')+' 17 B';
    ini_close();
    // Spawn
...
// Walls (Horizontal)
room_instance_add(argument0,272,260,wall_hor_obj);
room_instance_add(argument0,272,284,wall_hor_obj);
room_instance_add(argument0,304,260,wall_hor_obj);
room_instance_add(argument0,336,260,wall_hor_obj);
room_instance_add(argument0,368,260,wall_hor_obj);
room_instance_add(argument0,400,260,wall_hor_obj);
room_instance_add(argument0,432,260,wall_hor_obj);
room_instance_add(argument0,464,260,wall_hor_obj);
room_instance_add(argument0,496,260,wall_hor_obj);
room_instance_add(argument0,528,260,wall_hor_obj);
room_instance_add(argument0,560,260,wall_hor_obj);
room_instance_add(argument0,592,260,wall_hor_obj);
room_instance_add(argument0,304,284,wall_hor_obj);
room_instance_add(argument0,336,284,wall_hor_obj);
...
room_instance_add(argument0,464,284,wall_hor_obj);
room_instance_add(argument0,496,284,wall_hor_obj);
room_instance_add(argument0,528,284,wall_hor_obj);
room_instance_add(argument0,560,284,wall_hor_obj);
room_instance_add(argument0,592,320,wall_hor_obj);
// Walls (Vertical)
room_instance_add(argument0,256,272,wall_vert_obj);
room_instance_add(argument0,576,300,wall_vert_obj);
room_instance_add(argument0,576,332,wall_vert_obj);
