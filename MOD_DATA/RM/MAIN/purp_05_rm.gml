...
(
    argument0,"
    global.rm_name_var = 'Purple Room 5 / Small Room 13'
    // Spawn
...
room_instance_add(argument0,368,240,wall_doorway_hor_obj);
room_instance_add(argument0,368,208,wall_doorway_hor_obj);
room_instance_add(argument0,368,336,wall_doorway_hor_obj);
room_instance_add(argument0,368,368,wall_doorway_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,192,160,wall_doorway_vert_obj);
room_instance_add(argument0,288,160,wall_doorway_vert_obj);
room_instance_add(argument0,320,160,wall_doorway_vert_obj);
room_instance_add(argument0,416,416,wall_doorway_vert_obj);
// Torches
