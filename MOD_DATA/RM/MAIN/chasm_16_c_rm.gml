...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 16 C";
    ini_close();
    // Spawn
...
room_instance_add(argument0,432,352,floor_bridge_fake_n56px_vert_obj);
room_instance_add(argument0,432,320,floor_bridge_fake_n56px_vert_obj);
room_instance_add(argument0,432,288,floor_bridge_fake_n56px_vert_obj);
room_instance_add(argument0,432,256,floor_bridge_fake_n56px_vert_obj);
room_instance_add(argument0,496,256,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,496,288,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,496,320,floor_bridge_n56px_vert_obj);
room_instance_add(argument0,496,352,floor_bridge_n56px_vert_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,416,352,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,416,320,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,416,288,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,416,256,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,448,352,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,448,320,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,448,288,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,448,256,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,480,256,rail_wood_n56px_vert_obj);
room_instance_add(argument0,480,288,rail_wood_n56px_vert_obj);
room_instance_add(argument0,480,320,rail_wood_n56px_vert_obj);
room_instance_add(argument0,480,352,rail_wood_n56px_vert_obj);
room_instance_add(argument0,512,256,rail_wood_n56px_vert_obj);
room_instance_add(argument0,512,288,rail_wood_n56px_vert_obj);
room_instance_add(argument0,512,320,rail_wood_n56px_vert_obj);
room_instance_add(argument0,512,352,rail_wood_n56px_vert_obj);
// Torches
