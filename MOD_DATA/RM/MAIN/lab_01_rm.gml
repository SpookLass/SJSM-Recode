...
(
    ...
    // Doors
    spawn_create_scr(true,false,0,lab_door_obj,spawn_door_trig_obj);
    // Exit
    with global.spawn_arr[1,4] { lock_var = true; }
    with global.spawn_arr[2,4] { rm_var = lab_02_rm; snd_len_var = 1; snd_arr[0] = door_m_02_snd; }
    with global.spawn_arr[3,4] { rm_var = lab_03_rm; rm_count_var = 1; lock_var = !load_par_obj.key_var; txt_lock_var = local.lock; snd_len_var = 1; snd_arr[0] = door_m_02_snd; }
');
// Room settings
...
// Floors
room_instance_add(argument0,176,240,lab_floor_obj);
room_instance_add(argument0,208,240,lab_floor_obj);
room_instance_add(argument0,240,240,lab_floor_obj);
room_instance_add(argument0,272,240,lab_floor_obj);
room_instance_add(argument0,304,240,lab_floor_obj);
room_instance_add(argument0,336,240,lab_floor_obj);
room_instance_add(argument0,368,240,lab_floor_obj);
room_instance_add(argument0,400,240,lab_floor_obj);
room_instance_add(argument0,336,208,lab_floor_obj);
room_instance_add(argument0,368,208,lab_floor_obj);
room_instance_add(argument0,400,208,lab_floor_obj);
room_instance_add(argument0,400,272,lab_floor_obj);
room_instance_add(argument0,368,272,lab_floor_obj);
room_instance_add(argument0,336,272,lab_floor_obj);
room_instance_add(argument0,432,208,lab_floor_obj);
room_instance_add(argument0,432,240,lab_floor_obj);
room_instance_add(argument0,432,272,lab_floor_obj);
room_instance_add(argument0,464,208,lab_floor_obj);
room_instance_add(argument0,464,240,lab_floor_obj);
room_instance_add(argument0,496,240,lab_floor_obj);
room_instance_add(argument0,528,240,lab_floor_obj);
room_instance_add(argument0,400,176,lab_floor_obj);
room_instance_add(argument0,400,144,lab_floor_obj);
room_instance_add(argument0,400,304,lab_floor_obj);
room_instance_add(argument0,400,336,lab_floor_obj);
room_instance_add(argument0,464,272,lab_floor_obj);
// Ceilings
