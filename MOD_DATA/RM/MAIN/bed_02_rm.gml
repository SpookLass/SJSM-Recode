...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 2";
    ini_close();
    // Spawn
...
room_instance_add(argument0,240,480,rain_window_part_obj);
// Floors
...
room_instance_add(argument0,192,336,bed_rand_obj);
room_instance_add(argument0,288,344,table_rand_obj);