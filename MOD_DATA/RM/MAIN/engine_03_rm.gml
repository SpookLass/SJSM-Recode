...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","engine","ROOM_engine")+" 3";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,1] = 230;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 201;
    global.mark_arr[1,1] = 318;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 260;
    global.mark_arr[2,1] = 344;
