...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 10 B";
    ini_close();
    // Spawn
...
room_instance_add(argument0,336,288,floor_bridge_60px_vert_obj);
room_instance_add(argument0,336,320,floor_bridge_60px_vert_obj);
...
room_instance_add(argument0,352,288,rail_wood_60px_vert_obj);
room_instance_add(argument0,352,320,rail_wood_60px_vert_obj);
