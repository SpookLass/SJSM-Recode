...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','hall','ROOM_hall')+' 34';
    ini_close();
    // Spawn
...
room_instance_add(argument0,368,356,wall_hor_obj); // Higher
room_instance_add(argument0,400,356,wall_hor_obj);
room_instance_add(argument0,432,356,wall_hor_obj);
room_instance_add(argument0,176,452,wall_hor_obj);
room_instance_add(argument0,208,452,wall_hor_obj);
room_instance_add(argument0,240,452,wall_hor_obj);
room_instance_add(argument0,304,452,wall_hor_obj);
room_instance_add(argument0,336,452,wall_hor_obj);
room_instance_add(argument0,456,452,wall_hor_obj);
room_instance_add(argument0,488,452,wall_hor_obj);
room_instance_add(argument0,272,548,wall_hor_obj);
room_instance_add(argument0,400,380,wall_hor_obj); // Lower
room_instance_add(argument0,176,476,wall_hor_obj);
room_instance_add(argument0,208,476,wall_hor_obj);
room_instance_add(argument0,336,476,wall_hor_obj);
room_instance_add(argument0,368,476,wall_hor_obj);
room_instance_add(argument0,432,476,wall_hor_obj);
room_instance_add(argument0,464,476,wall_hor_obj);
room_instance_add(argument0,496,476,wall_hor_obj);
room_instance_add(argument0,304,572,wall_hor_obj);
room_instance_add(argument0,272,572,wall_hor_obj);
room_instance_add(argument0,240,572,wall_hor_obj);
// Walls (Vertical)
room_instance_add(argument0,96,464,wall_vert_obj);
room_instance_add(argument0,504,464,wall_vert_obj);
room_instance_add(argument0,160,436,wall_vert_obj); // Higher
room_instance_add(argument0,256,532,wall_vert_obj);
room_instance_add(argument0,256,500,wall_vert_obj);
room_instance_add(argument0,256,468,wall_vert_obj);
room_instance_add(argument0,288,468,wall_vert_obj);
room_instance_add(argument0,288,500,wall_vert_obj);
room_instance_add(argument0,288,532,wall_vert_obj);
room_instance_add(argument0,352,372,wall_vert_obj);
room_instance_add(argument0,352,404,wall_vert_obj);
room_instance_add(argument0,352,436,wall_vert_obj);
room_instance_add(argument0,440,372,wall_vert_obj);
room_instance_add(argument0,440,404,wall_vert_obj);
room_instance_add(argument0,440,436,wall_vert_obj);
room_instance_add(argument0,160,492,wall_vert_obj); // Lower
room_instance_add(argument0,224,492,wall_vert_obj);
room_instance_add(argument0,224,524,wall_vert_obj);
room_instance_add(argument0,224,556,wall_vert_obj);
room_instance_add(argument0,320,492,wall_vert_obj);
room_instance_add(argument0,320,524,wall_vert_obj);
room_instance_add(argument0,320,556,wall_vert_obj);
room_instance_add(argument0,384,460,wall_vert_obj);
room_instance_add(argument0,384,428,wall_vert_obj);
room_instance_add(argument0,384,396,wall_vert_obj);
room_instance_add(argument0,416,396,wall_vert_obj);
room_instance_add(argument0,416,428,wall_vert_obj);
room_instance_add(argument0,416,460,wall_vert_obj);