...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','big','ROOM_chasm')+' 2 A';
    ini_close();
    // Spawn
...
room_instance_add(argument0,320,240,floor_bridge_3high_hor_obj);
room_instance_add(argument0,320,272,floor_bridge_3high_hor_obj);
room_instance_add(argument0,320,304,floor_bridge_3high_hor_obj);
room_instance_add(argument0,320,336,floor_bridge_3high_hor_obj);
room_instance_add(argument0,240,240,floor_bridge_n56px_hor_obj);
room_instance_add(argument0,240,272,floor_bridge_n56px_hor_obj);
room_instance_add(argument0,240,304,floor_bridge_n56px_hor_obj);
room_instance_add(argument0,240,336,floor_bridge_n56px_hor_obj);
// Walls (Horizontal)
