...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 4 B";
	ini_close();
    // Spawn
...
room_instance_add(argument0,320,368,ceil_2high_obj);
room_instance_add(argument0,320,336,ceil_2high_obj);
room_instance_add(argument0,352,336,ceil_2high_obj);
room_instance_add(argument0,352,368,ceil_2high_obj);
