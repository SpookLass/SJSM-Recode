...
room_instance_add(argument0,320,368,floor_high_obj);
room_instance_add(argument0,320,336,floor_high_obj);
room_instance_add(argument0,352,336,floor_high_obj);
room_instance_add(argument0,352,368,floor_high_obj);
...
// Ceilings
room_instance_add(argument0,128,272,ceil_high_obj);
room_instance_add(argument0,160,272,ceil_high_obj);
room_instance_add(argument0,128,240,ceil_high_obj);
room_instance_add(argument0,160,240,ceil_high_obj);
room_instance_add(argument0,192,240,ceil_high_obj);
room_instance_add(argument0,224,240,ceil_high_obj);
room_instance_add(argument0,224,272,ceil_high_obj);
room_instance_add(argument0,192,272,ceil_high_obj);
room_instance_add(argument0,192,304,ceil_high_obj);
room_instance_add(argument0,160,304,ceil_high_obj);
room_instance_add(argument0,128,304,ceil_high_obj);
room_instance_add(argument0,224,304,ceil_high_obj);
room_instance_add(argument0,256,304,ceil_high_obj);
room_instance_add(argument0,256,272,ceil_high_obj);
room_instance_add(argument0,256,240,ceil_high_obj);
room_instance_add(argument0,288,336,ceil_high_obj);
room_instance_add(argument0,288,368,ceil_high_obj);
room_instance_add(argument0,320,368,ceil_high_obj);
room_instance_add(argument0,320,336,ceil_high_obj);
room_instance_add(argument0,352,336,ceil_high_obj);
room_instance_add(argument0,352,368,ceil_high_obj);
room_instance_add(argument0,224,336,ceil_high_obj);
room_instance_add(argument0,256,336,ceil_high_obj);
room_instance_add(argument0,224,368,ceil_high_obj);
room_instance_add(argument0,256,368,ceil_high_obj);
room_instance_add(argument0,192,368,ceil_high_obj);
room_instance_add(argument0,192,336,ceil_high_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,368,336,wall_2high_vert_obj);
room_instance_add(argument0,368,368,wall_2high_vert_obj);
// Torches
// Props
