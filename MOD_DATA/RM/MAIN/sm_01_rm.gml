...
(
	...
	global.rm_name_var = ini_read_string('ROOM','sm','ROOM_sm')+' 1';
	ini_close();
    // Spawn
...
room_instance_add(argument0,368,320,torch_east_obj);
room_instance_add(argument0,368,192,torch_east_obj);
// Props
...
room_instance_add(argument0,368,256,frame_vert_rand_obj);
room_instance_add(argument0,288,336,frame_hor_rand_obj);