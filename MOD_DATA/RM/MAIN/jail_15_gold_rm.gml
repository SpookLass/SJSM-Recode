...
(
    argument0,"
    global.rm_name_var = 'Jail Room 15 Gold'
    // Spawn
   ...
   // Exit
    ...
    // Forward
    local.torch = instance_create(368,288,torch_gold_north_obj);
    local.torch.door_var = global.spawn_arr[1,4];
    local.torch = instance_create(368,320,torch_gold_south_obj);
    local.torch.door_var = global.spawn_arr[1,4];
    // Left
    local.torch = instance_create(288,240,torch_gold_west_obj);
    local.torch.door_var = global.spawn_arr[2,4];
    local.torch = instance_create(320,240,torch_gold_east_obj);
    local.torch.door_var = global.spawn_arr[2,4];
    local.torch = instance_create(176,96,torch_gold_north_obj);
    local.torch.door_var = global.spawn_arr[2,4];
    local.torch = instance_create(240,96,torch_gold_north_obj);
    local.torch.door_var = global.spawn_arr[2,4];
    // Right
    local.torch = instance_create(288,368,torch_gold_west_obj);
    local.torch.door_var = global.spawn_arr[3,4];
    local.torch = instance_create(320,368,torch_gold_east_obj);
    local.torch.door_var = global.spawn_arr[3,4];
    local.torch = instance_create(176,512,torch_gold_south_obj);
    local.torch.door_var = global.spawn_arr[3,4];
    local.torch = instance_create(240,512,torch_gold_south_obj);
    local.torch.door_var = global.spawn_arr[3,4];
")
// Room settings
