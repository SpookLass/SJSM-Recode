...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','engine','ROOM_engine')+' 10';
    ini_close();
    // Spawn
...
// Engineering
room_instance_add(argument0,192,320,bar_vert_obj);
...
// Jumpscare
room_instance_add(argument0,320,336,js_obj);