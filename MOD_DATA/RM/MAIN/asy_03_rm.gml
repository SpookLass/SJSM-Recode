...
(
    ...
    { global.spawn_arr[0,4] = id; rm_var = asy_02_rm; spawn_var = 1; snd_len_var = 1; snd_arr[0] = door_m_02_snd; }
    with spawn_arr[1,4] { rm_var = asy_04_rm; snd_len_var = 1; snd_arr[0] = door_m_02_snd; }
