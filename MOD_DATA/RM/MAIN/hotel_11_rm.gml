...
(
	...
	global.rm_name_var = ini_read_string('ROOM','hotel','ROOM_hotel')+' 11';
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 309;
    global.mark_arr[0,1] = 274;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 277;
    global.mark_arr[1,1] = 325;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 317;
    global.mark_arr[2,1] = 333;
