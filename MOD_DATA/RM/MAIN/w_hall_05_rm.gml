...
(
	...
	global.rm_name_var = ini_read_string('ROOM','w','ROOM_w')+' 5';
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 139;
    global.mark_arr[0,1] = 211;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 208;
    global.mark_arr[1,1] = 183;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 117;
    global.mark_arr[2,1] = 82;
...
room_instance_add(argument0,224,80,wall_vert_obj);
// Torches
room_instance_add(argument0,176,64,torch_north_obj);
room_instance_add(argument0,176,96,torch_south_obj);
/**/