...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 5";
    ini_close();
    // Spawn
    ...
    global.mark_arr[1,1] = 331;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 214;
...
// Props
room_instance_add(argument0,192,272,bed_rand_obj);
room_instance_add(argument0,288,264,drawer_rand_south_obj);
room_instance_add(argument0,240,256,frame_hor_rand_obj);
