...
(
	...
	global.rm_name_var = ini_read_string('ROOM','sm_lab','ROOM_sm_lab')+' 16';
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 172;
    global.mark_arr[0,1] = 276;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 237;
    global.mark_arr[1,1] = 265;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 291;
    global.mark_arr[2,1] = 274;
...
room_instance_add(argument0,224,208,floor_high_obj);
room_instance_add(argument0,224,176,floor_high_obj);
...
room_instance_add(argument0,208,176,wall_2high_vert_obj);
...
room_instance_add(argument0,240,336,wall_2high_vert_obj);
room_instance_add(argument0,240,368,wall_2high_vert_obj);
// Props
