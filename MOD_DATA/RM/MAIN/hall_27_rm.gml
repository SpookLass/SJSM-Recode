...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','hall','ROOM_hall')+' 27';
    ini_close();
    // Spawn
...
// Torches
room_instance_add(argument0,368,288,torch_north_obj);
room_instance_add(argument0,464,288,torch_north_obj);
room_instance_add(argument0,304,448,torch_south_obj);
room_instance_add(argument0,400,448,torch_south_obj);