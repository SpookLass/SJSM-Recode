...
(
	...
	global.rm_name_var = ini_read_string("ROOM","sm_lab","ROOM_sm_lab")+" 12";
	ini_close();
    // Spawn
...
room_instance_add(argument0,224,272,floor_high_obj);
room_instance_add(argument0,256,272,floor_high_obj);
room_instance_add(argument0,288,272,floor_high_obj);
// Ceilings
...
room_instance_add(argument0,288,288,wall_2high_hor_obj);
