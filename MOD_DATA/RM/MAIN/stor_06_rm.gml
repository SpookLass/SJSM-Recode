...
(
	...
	global.rm_name_var = ini_read_string("ROOM","stor","ROOM_stor")+" 6";
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 408;
    global.mark_arr[0,1] = 294;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 490;
    global.mark_arr[1,1] = 323;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 527;
    global.mark_arr[2,1] = 295;
...
room_instance_add(argument0,528,352,ceil_2high_obj);
...
room_instance_add(argument0,528,272,wall_2high_hor_obj);
...
room_instance_add(argument0,496,288,crate_rand_obj);
room_instance_add(argument0,464,288,crate_rand_obj);
room_instance_add(argument0,528,352,crate_rand_obj);
room_instance_add(argument0,496,352,crate_rand_obj);
room_instance_add(argument0,400,352,crate_rand_obj);
room_instance_add(argument0,384,304,pole_wood_obj);
room_instance_add(argument0,448,304,pole_wood_obj);
room_instance_add(argument0,448,336,pole_wood_obj);
room_instance_add(argument0,384,336,pole_wood_obj);