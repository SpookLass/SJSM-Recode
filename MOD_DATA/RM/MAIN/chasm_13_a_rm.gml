...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 13 A";
    ini_close();
    // Spawn
...
room_instance_add(argument0,256,256,floor_bridge_fake_n56px_vert_obj);
...
room_instance_add(argument0,256,352,floor_bridge_fake_n56px_vert_obj);
// Walls (Horizontal)
...
room_instance_add(argument0,240,256,rail_wood_fake_n56px_vert_obj);
...
room_instance_add(argument0,240,352,rail_wood_fake_n56px_vert_obj);
room_instance_add(argument0,272,256,rail_wood_fake_n56px_vert_obj);
...
room_instance_add(argument0,272,352,rail_wood_fake_n56px_vert_obj);
// Torches