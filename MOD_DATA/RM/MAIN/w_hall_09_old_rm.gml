...
(
	...
	global.rm_name_var = ini_read_string('ROOM','w','ROOM_w')+' 8 '+ini_read_string('ROOM','old','ROOM_old');
	ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 173;
    global.mark_arr[0,1] = 195;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 226;
...
room_instance_add(argument0,320,304,wall_vert_obj);
