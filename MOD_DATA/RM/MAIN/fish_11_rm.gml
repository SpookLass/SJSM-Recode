...
(
	...
	global.rm_name_var = ini_read_string('ROOM','fish','ROOM_fish')+' 11';
	ini_close();
    ...
    global.mark_arr[0,0] = 296;
    global.mark_arr[0,1] = 263;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 410;
    global.mark_arr[1,1] = 263;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 415;
    global.mark_arr[2,1] = 404;
...
room_instance_add(argument0,384,320,tank_rand_obj);
room_instance_add(argument0,384,352,tank_rand_obj);
room_instance_add(argument0,384,384,tank_rand_obj);
room_instance_add(argument0,448,384,tank_rand_obj);
room_instance_add(argument0,384,416,tank_rand_obj);
room_instance_add(argument0,448,416,tank_rand_obj);
room_instance_add(argument0,448,352,tank_rand_obj);
room_instance_add(argument0,448,320,tank_rand_obj);
...
room_instance_add(argument0,448,256,tank_rand_obj);
