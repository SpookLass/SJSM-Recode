...
(
    ...
    global.rm_name_var = ini_read_string('ROOM','big','ROOM_chasm')+' 4';
    ini_close();
    // Spawn
...
room_instance_add(argument0,208,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,240,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,272,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,304,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,336,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,368,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,400,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,432,272,floor_bridge_fake_3high_hor_obj);
room_instance_add(argument0,368,176,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,208,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,240,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,272,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,304,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,336,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,368,floor_bridge_fake_n56px_hor_obj);
room_instance_add(argument0,368,400,floor_bridge_fake_n56px_hor_obj);
// Walls (Horizontal)
