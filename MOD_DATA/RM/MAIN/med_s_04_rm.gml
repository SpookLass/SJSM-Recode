...
(
	...
	global.rm_name_var = ini_read_string("ROOM","med_s","ROOM_med_s")+" 4";
	ini_close();
    ...
    global.mark_arr[1,0] = 259;
    global.mark_arr[1,1] = 314;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 366;
    global.mark_arr[2,1] = 278;
...
room_instance_add(argument0,320,320,wall_pit_vert_obj);
room_instance_add(argument0,320,288,wall_pit_vert_obj);
room_instance_add(argument0,352,288,wall_pit_vert_obj);
room_instance_add(argument0,384,320,wall_pit_vert_obj);
...
room_instance_add(argument0,320,320,wall_float_vert_obj);
room_instance_add(argument0,320,288,wall_float_vert_obj);
room_instance_add(argument0,352,288,wall_float_vert_obj);
room_instance_add(argument0,384,320,wall_float_vert_obj);
