...
(
    argument0,"
    global.rm_name_var = 'Hotel Room 2'
    // Spawn
    ...
    global.mark_arr[0,1] = 271;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 401;
    global.mark_arr[1,1] = 180;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 441;
    global.mark_arr[2,1] = 132;
...
room_instance_add(argument0,400,96,wall_vert_obj);
...
// Props
room_instance_add(argument0,416,240,doorframe_01_hor_obj);
room_instance_add(argument0,416,240,doorframe_02_hor_obj);