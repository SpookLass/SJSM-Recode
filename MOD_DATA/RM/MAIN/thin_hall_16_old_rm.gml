...
(
	...
	global.rm_name_var = ini_read_string("ROOM","thin","ROOM_thin")+" 16 "+ini_read_string("ROOM","old","ROOM_old");
	ini_close();
...
room_instance_add(argument0,496,112,ceil_low_obj);
room_instance_add(argument0,528,112,ceil_low_obj);
