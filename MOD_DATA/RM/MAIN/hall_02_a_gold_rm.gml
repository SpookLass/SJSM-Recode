...
(
    ...
    if local.gold
    {
        ...
        // Torches
        local.torch = instance_create(176,480,torch_gold_south_obj);
        local.torch.door_var = global.spawn_arr[1,4];
        local.torch = instance_create(272,480,torch_gold_south_obj);
        local.torch.door_var = global.spawn_arr[2,4];
        local.torch = instance_create(368,480,torch_gold_south_obj);
    ...
    else
    {
        ...
        // Torches
        instance_create(176,480,torch_south_obj);
