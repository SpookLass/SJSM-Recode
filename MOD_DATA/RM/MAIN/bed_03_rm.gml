...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","bed","ROOM_bed")+" 3";
    ini_close();
    // Spawn
    ...
    global.mark_arr[0,0] = 262;
    global.mark_arr[0,1] = 288;
    global.mark_arr[0,2] = 0;
    global.mark_arr[1,0] = 238;
    global.mark_arr[1,1] = 345;
    global.mark_arr[1,2] = 0;
    global.mark_arr[2,0] = 291;
...
room_instance_add(argument0,240,608,rain_window_part_obj);
// Floors
...
room_instance_add(argument0,256,400,floor_obj);
...
room_instance_add(argument0,288,400,ceil_2high_obj);
room_instance_add(argument0,256,400,ceil_2high_obj);
room_instance_add(argument0,224,400,ceil_2high_obj);
...
room_instance_add(argument0,288,464,ceil_2high_obj);
room_instance_add(argument0,256,464,ceil_2high_obj);
room_instance_add(argument0,224,464,ceil_2high_obj);
...
room_instance_add(argument0,256,480,wall_hor_obj);
room_instance_add(argument0,192,256,wall_2high_hor_obj);
room_instance_add(argument0,224,256,wall_2high_hor_obj);
room_instance_add(argument0,288,256,wall_2high_hor_obj);
room_instance_add(argument0,256,256,wall_2high_hor_obj);
room_instance_add(argument0,192,480,wall_doorway_inv_hor_obj);
room_instance_add(argument0,224,480,wall_doorway_inv_hor_obj);
room_instance_add(argument0,256,480,wall_doorway_inv_hor_obj);
room_instance_add(argument0,288,480,wall_doorway_inv_hor_obj);
// Walls (Vertical)
...
room_instance_add(argument0,304,432,wall_2high_vert_obj);
...
room_instance_add(argument0,256,480,window_01_high_hor_obj);
room_instance_add(argument0,288,480,window_01_high_hor_obj);
room_instance_add(argument0,192,480,window_02_high_hor_obj);
room_instance_add(argument0,224,480,window_02_high_hor_obj);
room_instance_add(argument0,256,480,window_02_high_hor_obj);
room_instance_add(argument0,288,480,window_02_high_hor_obj);