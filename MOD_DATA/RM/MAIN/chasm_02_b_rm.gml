...
(
    ...
    global.rm_name_var = ini_read_string("ROOM","chasm","ROOM_chasm")+" 2 B";
    ini_close();
    // Spawn
...
room_instance_add(argument0,320,256,floor_bridge_3high_vert_obj);
room_instance_add(argument0,320,288,floor_bridge_3high_vert_obj);
room_instance_add(argument0,320,320,floor_bridge_3high_vert_obj);
room_instance_add(argument0,320,352,floor_bridge_3high_vert_obj);
...
room_instance_add(argument0,304,256,rail_wood_3high_vert_obj);
room_instance_add(argument0,304,288,rail_wood_3high_vert_obj);
room_instance_add(argument0,304,320,rail_wood_3high_vert_obj);
room_instance_add(argument0,304,352,rail_wood_3high_vert_obj);
room_instance_add(argument0,336,256,rail_wood_3high_vert_obj);
room_instance_add(argument0,336,288,rail_wood_3high_vert_obj);
room_instance_add(argument0,336,320,rail_wood_3high_vert_obj);
room_instance_add(argument0,336,352,rail_wood_3high_vert_obj);
