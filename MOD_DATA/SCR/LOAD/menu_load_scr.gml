...
type_arr[1,3] = false; // Custom Only
type_arr[1,4] = global.type_default_var; // Defaults to
type_arr[1,0] = "og";
type_arr[1,1] = "og";
type_arr[1,2] = true;
type_arr[1,3] = false;
...
custom_label_arr[global.custom_len_var,7] = true; // Translate
custom_label_arr[global.custom_len_var,8] = "taper"; // Value 5
...
mon_type_arr[global.mon_len_var,4] = "alt";
mon_type_arr[global.mon_len_var,5] = true; // Translate
mon_type_arr[global.mon_len_var,6] = "kh_mod";
mon_type_arr[global.mon_len_var,7] = true; // Translate
...
mon_type_arr[global.mon_len_var,0] = "old";
mon_type_arr[global.mon_len_var,1] = true; // Translate
mon_type_arr[global.mon_len_var,2] = "imscared";
mon_type_arr[global.mon_len_var,3] = true; // Translate
mon_type_arr[global.mon_len_var,4] = "alt";
mon_type_arr[global.mon_len_var,5] = true; // Translate
mon_type_arr[global.mon_len_var,6] = "imscared_mod";
mon_type_arr[global.mon_len_var,7] = true; // Translate
