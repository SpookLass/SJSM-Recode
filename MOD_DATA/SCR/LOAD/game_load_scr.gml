...
// Timing
    ...
    current_fulltime = (current_hour*3600)+(current_minute*60)+current_second;
    ...
    global.clock_time_var = 0;
    global.clock_hour_var = 0;
    global.clock_minute_var = 0;
    global.clock_second_var = 0;
    global.clock_millisecond_var = 0;
// Input
...
// Lists
    mon_list = ds_list_create();
    ds_list_clear(mon_list);
    mon_spawn_list = ds_list_create();
