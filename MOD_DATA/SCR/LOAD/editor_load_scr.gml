...
local.file = filename_change_ext(file_find_first(main_directory_const+"\SPR\EDITOR\*.gml",-1),"");
// Not sure why, but it doesn't include the path.
while (local.file != "")
{
    file_to_asset_scr(main_directory_const+"\SPR\EDITOR\"+local.file,filename_change_ext(local.file,""),argument0,1,false,false,0,0);
