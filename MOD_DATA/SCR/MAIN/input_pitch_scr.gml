...
switch global.input_cam_var[argument0]
{
    ...
    case cam_joy_r_const: // Joystick Right
    {
        ...
        { local.pitch = -joy_r_scr(global.joy_id_var[argument0])*global.delta_time_var*global.sens_var[argument0]/40; break; }
        return 0;
    }
    ...
    case cam_joy_l_const: // Joystick Left (should be universal)
    {
        ...
        { local.pitch = -joy_y_scr(global.joy_id_var[argument0])*global.delta_time_var*global.sens_var[argument0]/40; break; }
        return 0;
    }
    case cam_dpad_const: // D-Pad
    {
        ...
        && global.input_move_var[argument0] != move_dpad_const
        {
            ...
            if local.dir >= 0 { local.pitch = lengthdir_x(1,local.dir)*global.delta_time_var*global.sens_var[argument0]/40; break; }
        }
        return 0;
    }
