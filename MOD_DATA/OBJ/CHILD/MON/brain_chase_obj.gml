...
(argument0,ev_other,ev_user6,'
    ...
    if smart_var && instance_exists(target_var) && spd_var > 0
    {
        if target_var.spd_var > 0
        {
            ...
            local.raydist = check_ray_scr(target_x_var,target_y_var,target_z_var,target_var.x_spd_var,target_var.y_spd_var,target_var.z_spd_var)-(target_var.coll_var[1]*0.5,false);
