...
(argument0,ev_create,1,'
    ...
    if !local.loaded
    {
        ...
        if global.old_theme_var { mus_snd_var = fmod_snd_add_scr(main_directory_const+"\SND\MON\bug_mus_snd.mp3"); }
        else { mus_snd_var = fmod_snd_add_scr(main_directory_const+"\SND\MON\eel_mus_snd.mp3"); }
