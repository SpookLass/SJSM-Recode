...
(argument0,ev_create,1,'
    ...
    if !local.loaded
    {
        ...
        snd_arr[0,0] = snd_add_scr(fd_01_snd_path,true,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        snd_arr[1,0] = snd_add_scr(fd_02_snd_path,true,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        snd_arr[2,0] = snd_add_scr(fd_03_snd_path,true,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        snd_arr[3,0] = snd_add_scr(fd_04_snd_path,true,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        wake_snd_var[1] = snd_add_scr(fd_wake_snd_path,global.wake_3d_var,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        hurt_snd_var[1] = snd_add_scr(fd_hurt_snd_path,true,snd_group_mon_const,1,snd_dist_min_var,snd_dist_max_var);
        switch theme_scr(global.fd_theme_var,global.theme_var,1,0,0,1)
        {
            case 1: { mus_snd_var = snd_add_scr(fd_rom_mus_snd_path,false,snd_group_mus_const,1,0,0); break; }
