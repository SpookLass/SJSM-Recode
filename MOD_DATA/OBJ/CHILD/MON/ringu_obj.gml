...
(argument0,ev_create,1,'
    ...
    name_var = translate_mon_str_scr("ringu",global.name_var);
    ...
    hurt_snd_var[2] = string_replace(ini_read_string("SUB","ringu_hurt","SUB_ringu_hurt"),"@n",name_var); hurt_snd_var[3] = false;
    ini_close();
    type_var = 0;
    spd_base_var = 0.8;
    spr_spd_var = 1/6;
    ...
    if !local.loaded
    {
        ...
        switch theme_scr(global.ringu_theme_var,global.theme_var,3,0,0,1)
        {
