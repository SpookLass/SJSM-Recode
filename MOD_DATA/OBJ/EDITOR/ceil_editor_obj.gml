...
object_set_sprite(argument0,floor_editor_spr);
...
object_event_add(argument0,ev_draw,0,"
    ...
    if w_var > 1 || h_var > 1
    {
        for (local.i=0; local.i<w_var; local.i+=1;)
        {
            ...
            {
                draw_sprite_ext(sprite_index,image_index,x+(local.i*32),y+(local.j*32),image_xscale,image_yscale,image_angle,image_blend,image_alpha);
            }
        }
    }
