...
(argument0,ev_create,0,"
    ...
    button_arr[3,1] = 'SENSITIVITY'; // Label
    ...
    button_arr[5,1] = 'REDUCE FLASH'; // Label
    ...
    button_arr[6,1] = 'CROUCH TOGGLE'; // Label
    ...
    button_arr[7,1] = 'MAX PARTICLE COUNT'; // Label
    ...
    button_arr[9,1] = 'ANTI ALIASING'; // Label
    ...
    button_arr[10,1] = 'SUBTITLES'; // Label
    ...
    button_arr[11,1] = 'FULLSCREEN'; // Label
    ...
    button_arr[13,1] = 'COLLISION PRECISION'; // Label
    ...
    button_arr[14,1] = 'MOVEMENT BOBBING'; // Label
    ...
    button_arr[15,1] = 'IDLE BOBBING'; // Label
    ...
    button_arr[16,1] = 'SCREEN SHAKE'; // Label
    ...
    button_arr[17,1] = 'SAVE MEMORY'; // Label
    ...
    button_arr[18,1] = 'MONSTER HUD'; // Label
    ...
    button_arr[19,1] = 'ROOM HUD'; // Label
    ...
    button_arr[22,1] = 'FPS UPDATE'; // Label
    ...
    button_arr[23,1] = 'MONSTER NAMES'; // Label
    ...
    button_arr[24,1] = 'RESOLUTION WIDTH'; // Label
    ...
    button_arr[25,1] = 'RESOLUTION HEIGHT'; // Label
    ...
    button_arr[26,0] = 0;
    button_arr[26,1] = 'APPLY'
    button_arr[26,2] = 'Apply your settings. If you do not do this, your settings will not apply. Some settings may require a reload.'
    button_arr[26,3] = -1;

    button_arr[27,0] = 0;
    button_arr[27,1] = 'RESET'
    button_arr[27,2] = 'Reset all settings. CANNOT BE UNDONE'
    button_arr[27,3] = -3;

    button_arr[28,0] = 0;
    button_arr[28,1] = 'BACK'
    button_arr[28,2] = 'Back to the previous menu.'
    button_arr[28,3] = -2;
");
// Step Event
object_event_add
        ...
        switch button_arr[button_state_var,3]
        {
            ...
            case -2: // Go Back
            {
                if set_var
                {
                    ...
                    if local.message == 0 || local.message == 3 { break; }
...
(argument0,ev_other,ev_user0,"
    ...
    for (local.i=0; local.i<button_len_var; local.i+=1)
    {
        ...
        execute_string
        ("+'"'+"
            global."+'"'+"+button_arr[local.i,8]+"+'"'+"_var = button_arr[local.i,0];
            if button_arr[local.i,3] == 5 { ini_write_string('TEST',"+'"'+"+button_arr[local.i,8]+"+'"'+",button_arr[local.i,0]); }
            else { ini_write_real('TEST',"+'"'+"+button_arr[local.i,8]+"+'"'+",button_arr[local.i,0]); }
        "+'"'+");
    }
    ini_close();
");
...
(argument0,ev_draw,0,"
    ...
    for (local.i=0; local.i<button_len_var; local.i+=1)
    {
        ...
        {
            local.ytmp = 192+(96*(local.i-button_state_var));
            draw_set_color(str_bg_color_var);
    ...
    local.ytmp = 192//+(96*button_state_var);
