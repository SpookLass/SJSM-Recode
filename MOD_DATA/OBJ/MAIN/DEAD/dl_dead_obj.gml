...
");
    ...
    snd_01_var = snd_add_scr(dl_mus_snd_path,false,snd_group_mus_const,1,0,0);
    snd_02_var = snd_add_scr(choose(dl_eff_01_snd_path,dl_eff_02_snd_path,dl_eff_03_snd_path,dl_eff_04_snd_path),false,snd_group_sfx_const,1,0,0);
    // Sprite
    spr_id_var = 0;
    spr_spd_var = 1;
...
(argument0,ev_step,ev_step_normal,'
    ...
    if !state_var { spr_id_var = (spr_id_var+(spr_spd_var*global.true_delta_time_var)) mod sprite_get_number(spr_01_var); }
');
// Alarm 0 Event
object_event_add
