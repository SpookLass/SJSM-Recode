...
(argument0,ev_create,0,'
    if instance_exists(load_par_obj)
    {
        ...
        mdl_var = load_par_obj.mdl_arr_var[5,0];
        mdl_02_var = load_par_obj.mdl_arr_var[6,0];
        mdl_path_var = load_par_obj.mdl_arr_var[5,1];
    }
    event_inherited();
    solid_var = false;
    direction = -90;
...
(argument0,ev_draw,0,'
    ...
    draw_set_color(light_color_scr(image_blend));
