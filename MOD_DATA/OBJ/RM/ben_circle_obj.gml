...
(argument0,ev_draw,0,'
    ...
    // Prop types
    d3d_draw_floor(-w_var*0.5,-l_var*0.5,dist_var,0,0,dist_var,local.tex,tex_w_var,tex_h_var);
    d3d_draw_floor(0,0,dist_var,w_var*0.5,l_var*0.5,dist_var,local.tex,-tex_w_var,-tex_h_var);
    d3d_draw_floor(-w_var*0.5,0,dist_var,0,l_var*0.5,dist_var,local.tex,tex_w_var,-tex_h_var);
    d3d_draw_floor(0,-l_var*0.5,dist_var,w_var*0.5,0,dist_var,local.tex,-tex_w_var,tex_h_var);
    // Reset
    d3d_transform_set_identity();
